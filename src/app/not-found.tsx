...
export default function NotFound() {
    return (
        <div className={`${montserrat.className} relative  w-screen h-screen flex justify-center items-center`} >
            <div className="inline-flex flex-col gap-y-8 xl:gap-y-10 items-center justify-start" >
                ...
                <button
                    className="
                        ...
                        w-full max-w-[22rem] md:max-w-[13rem] xl:max-w-[23rem]
                        bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800"
                >
                    <Link href="/home" className="whitespace-nowrap text-base md:text-sm xl:text-2xl font-medium text-white">
                        На главную
                    </Link>
                </button>
            </div>
